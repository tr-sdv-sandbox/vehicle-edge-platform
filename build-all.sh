...
echo "  $BUILD_DIR/vep-core/vdr_exporter"
echo "  $BUILD_DIR/vep-core/cloud_backend_sim"
echo "  $BUILD_DIR/vep-core/probes/vss_can/vdr_vss_can_probe"
echo "  $BUILD_DIR/vep-core/probes/otel/vdr_otel_probe"
echo ""
